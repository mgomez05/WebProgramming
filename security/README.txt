...
For this assignment, I performed a security assement of a potentially vulnerable 
web applications. After using command line tools such as curl, reading over the source code
...
a list of issues complete with the location, severity, proof, and resolution for each one, and 
a conclusion.
...
page complete with the requirements listed in the specification, and it contains at least
...
----------Time Spent-----------------
I spent 6 hours on this assignment, with much time spent to styling the index.html page
